...
const ExpenseCategoryInput = ({ onChange, value }) => {
  ...
  const categories = [
    ...
    { name: "Transporte", icon: <DirectionsCarIcon className={classes.icon} /> },
    { name: "Vestuário", icon: <ShoppingBasketIcon className={classes.icon} /> },
    ...
    { name: "Atividades ao ar livre", icon: <NaturePeopleIcon className={classes.icon} /> },
    { name: "Piscina", icon: <PoolIcon className={classes.icon} /> },
    { name: "Bebidas", icon: <LocalBarIcon className={classes.icon} /> },
    { name: "Jogos de Tabuleiro", icon: <CasinoIcon className={classes.icon} /> },
    { name: "Eletrônicos", icon: <LaptopIcon className={classes.icon} /> },
    { name: "Carros", icon: <DirectionsCarOutlinedIcon className={classes.icon} /> },
    { name: "Cosmesticos", icon: <BrushIcon className={classes.icon} /> },
    { name: "Instrumentos Musicais", icon: <MusicNoteIcon className={classes.icon} /> },
    ...
    { name: "Assinaturas", icon: <FormatListNumberedIcon className={classes.icon} /> },
    { name: "Padaria", icon: <EmojiFoodBeverageIcon className={classes.icon} /> },
    ...
    { name: "Frutas", icon: <LocalGroceryStoreIcon className={classes.icon} /> },
    { name: "Ferramentas", icon: <BuildIcon className={classes.icon} /> },
    { name: "Supermercado", icon: <ShoppingCartIcon className={classes.icon} /> },
    { name: "Lavanderia", icon: <LocalLaundryServiceIcon className={classes.icon} /> },
    { name: "Contas", icon: <AccountBalanceIcon className={classes.icon} /> },
    { name: "Investimentos", icon: <AttachMoneyIcon className={classes.icon} /> },
    { name: "Lista de compras", icon: <ListAltIcon className={classes.icon} /> },
    { name: "Outros", icon: <FormatListNumberedIcon className={classes.icon} /> }
    ];
